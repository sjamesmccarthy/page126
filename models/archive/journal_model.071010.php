...
{   
	...
	/* Delete all tags by entry_id and then insert back */
...
function _update_settings()
{
	...
	/* Set Prefs */
	/* **************************************** */
	// for elements for prefs are:
	// $trash_redir ($pref_trash_redir) = trash
	// $login_redir ($pref_login_redir) = entry_new
	// $show_redir ($pref_show_index_redir) = show_index
	// $default_journal ($pref_default_journal) = default_journal
	// $timezone ($pref_timezone) = timezone
	// $theme_pref ($pref_theme) = default_theme
	// pref_hide_entry_pswd = hide_entry_pswd
	// $pref_email_reminder = email_reminder {$pref_email_reminder_time}
	...
	/* update SESSION variables with new prference settings 
